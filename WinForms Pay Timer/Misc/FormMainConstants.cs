...
public static class FormMainConstants
{
    ...
    public const int EmpytySpaceTop = 0;
    public const int EmpytySpaceBottom = 130;
    ...
    public const string MsgResetTimerWarning = "You are about to reset the timer for the current job! Current time will be lost.";
}
